...
public class CBT11_Test_CorrectDeleteAccount_TuCuenta extends ClaireandbruceTestCase{
	 ...
	 *al validar la selección de razones causantes  del deseo de eliminación de
	 *la cuenta por parte del usuario. 
	 *El  éxito  del proceso se evaluará al mostrar el mensaje "Su cuenta    ha
	 *sido  desactivada con éxito.".  Así   como informar a través del  mensaje
	 *"Esta cuenta no esta activa" cuando  se intente  acceder   nuevamente  al 
	 *sistema con la  información  de un usuario  que ha  desactivado su cuenta 
	 *previamente. 
	 * 
	 * */
	@Test
