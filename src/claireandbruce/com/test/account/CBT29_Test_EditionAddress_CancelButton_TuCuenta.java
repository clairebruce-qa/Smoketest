 ...
 *
 */
public class CBT29_Test_EditionAddress_CancelButton_TuCuenta extends ClaireandbruceTestCase {
	...
	public void test_EditionAddress_CancelButton_TuCuenta() throws Exception{
		...
		if(selenium.isTextPresent("No tienes ninguna dirección de envío por defecto en tu libreta de direcciones.")){
			CBT14_Test_User_Addres_1_Add_Shipping_Address_User_with_Valid_Fields tb = new CBT14_Test_User_Addres_1_Add_Shipping_Address_User_with_Valid_Fields();
