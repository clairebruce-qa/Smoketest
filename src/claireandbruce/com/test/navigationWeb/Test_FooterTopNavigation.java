...
public class Test_FooterTopNavigation extends ClaireandbruceTestCase {
	...
	public void CBT93() throws Exception {
		...
		if(selenium.isElementPresent("xpath=.//*[@id='question-category-block']/div[1]/ul/li[1]/a")){
			Assert.fail("No se encontro ventana de ayuda");
		}
		...
		if(!selenium.isElementPresent("xpath=//div[4]/a/cufon/canvas"))
		{
			Assert.fail("No se encontro ventana de información Sobre Nosotros");
		}
